...
const table = 'progress_trackings'
const validation = require("../services/validation")

async function create(data) {
    const obj = { table, columns: Object.keys(data), values: Object.values(data) }
    const validate = validation.validateProgressTrackingsTable(data, "create")
...
async function update(data) {
    ...
    const validate = validation.validateProgressTrackingsTable(data, "update")
    if (Object.values(validate).every(item => item === "")) {
